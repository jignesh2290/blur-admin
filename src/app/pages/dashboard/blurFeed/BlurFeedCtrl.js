...
(function () {
    ...
    /** @ngInject */
    function BlurFeedCtrl($scope, $uibModal, authService) {
        $scope.openRegisterModal = function (size) {
            var modalInstance = $uibModal.open({
                animation: true,
                templateUrl: 'app/pages/auth/register/reg.html',
            ...
            modalInstance.result.then(function (isRegistered) {
                if (isRegistered) {
                    $scope.openLoginModal('md');
                }
            });
        };
        ...
        $scope.openLoginModal = function (size) {
            var modalInstance = $uibModal.open({
                animation: true,
                templateUrl: 'app/pages/auth/login/auth.html',
